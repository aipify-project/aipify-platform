...
**Community & Collective Intelligence (Phase 89):** See [COMMUNITY_COLLECTIVE_INTELLIGENCE_PHASE89.md](./COMMUNITY_COLLECTIVE_INTELLIGENCE_PHASE89.md) — governed contributions, anonymization, Community Health Score, Collective Contribution Score, community briefings. `/app/community`, `lib/aipify/community-intelligence/`, migration `20260618100000_community_collective_intelligence_phase89.sql`. Collective Intelligence amplifies wisdom; not compromise trust.
