...
export type EnterpriseCtaBandLabels = {
  title: string;
  subtitle?: string;
...
type EnterpriseCtaBandProps = EnterpriseCtaBandLabels;
        ...
        <div className="rounded-3xl border border-cyan-500/20 bg-gradient-to-r from-cyan-500/10 via-blue-600/10 to-violet-600/10 px-8 py-12 text-center sm:px-12">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row sm:flex-wrap">
            <Link
              ...
              {...marketingDataAttr("cta_click", "enterprise_cta_book_demo")}
            >
              {bookEnterpriseDemo}
            </Link>
            <Link
              ...
              {...marketingDataAttr("cta_click", "enterprise_cta_speak_with_aipify")}
            >
              {speakWithAipify}
            </Link>
            <Link
              ...
              className={`w-full sm:w-auto ${AipifyMarketingClasses.secondaryCta} px-7 py-3.5 text-base`}
              {...marketingDataAttr("cta_click", "enterprise_cta_early_access")}
            >
              {earlyAccess}
            </Link>
          </div>
