    ...
    <>
      ...
      <div className="mx-auto max-w-[77.5rem] px-4 pb-12 sm:px-6 lg:px-8">
        <header className="max-w-3xl">
          <h1 className={PublicMarketingClasses.pageTitle}>{category.name}</h1>
          <p className="mt-4 text-lg leading-relaxed text-aipify-text-secondary">{category.description}</p>
        </header>
