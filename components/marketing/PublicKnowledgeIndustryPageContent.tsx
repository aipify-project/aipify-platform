...
import type { PublicKnowledgeHubLabels, PublicKnowledgeIndustry } from "@/lib/marketing/knowledge/types";
...
export default function PublicKnowledgeIndustryPageContent({
  ...
  return (
    <>
      <MarketingPageHeader title={industry.name} subtitle={industry.description} />
