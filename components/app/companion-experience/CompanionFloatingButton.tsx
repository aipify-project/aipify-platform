...
export function CompanionFloatingButton() {
  ...
  return (
    <button
      ...
      className="group fixed bottom-20 right-4 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-white shadow-lg ring-2 ring-emerald-200/80 transition hover:ring-emerald-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-aipify-companion focus-visible:ring-offset-2 sm:bottom-6 sm:right-6 lg:bottom-8"
      data-companion-floating
    >
      <CompanionIcon size={44} availabilityRing ariaLabel={labels.ariaCompanionAvailable} />
      <span className="sr-only">{labels.companionAvailable}</span>
