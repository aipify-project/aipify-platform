...
/** Hard limit for a single worker turn — fail with retryable error. */
...
export const COMPANION_QUEUE_UI_WORKING_MS = 10_000;
/** UI: explain longer-than-normal wait. */
export const COMPANION_QUEUE_UI_LONG_WAIT_MS = 30_000;
