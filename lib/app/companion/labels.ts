...
export function buildCompanionExperienceLabels(t: Translator): CompanionExperienceLabels {
  ...
  return {
    ...
    roleHeading: t(`${p}.roleHeading`),
    roleFallback: t(`${p}.roleFallback`),
    roles: {
      owner: t(`${p}.roles.owner`),
      admin: t(`${p}.roles.admin`),
      support: t(`${p}.roles.support`),
      staff: t(`${p}.roles.staff`),
      read_only: t(`${p}.roles.read_only`),
      manager: t(`${p}.roles.manager`),
      moderator: t(`${p}.roles.moderator`),
      growth_partner: t(`${p}.roles.growth_partner`),
    },
    ...
    recentArchive: t(`${p}.recentArchive`),
    recentActive: t(`${p}.recentActive`),
    conversations: {
      confirmDelete: t(`${p}.conversations.confirmDelete`),
      confirmArchive: t(`${p}.conversations.confirmArchive`),
      deleteFailed: t(`${p}.conversations.deleteFailed`),
      archiveFailed: t(`${p}.conversations.archiveFailed`),
      cancel: t(`${p}.conversations.cancel`),
    },
    replyToast: {
      viewReply: t(`${p}.replyToast.viewReply`),
      dismiss: t(`${p}.replyToast.dismiss`),
      openConversation: t(`${p}.replyToast.openConversation`),
    },
    ...
    queue: {
      ...
      statusFailed: t(`${p}.queue.statusFailed`),
      statusCancelled: t(`${p}.queue.statusCancelled`),
      statusWorking: t(`${p}.queue.statusWorking`),
      statusLongWait: t(`${p}.queue.statusLongWait`),
