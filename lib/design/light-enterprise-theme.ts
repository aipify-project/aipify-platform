...
export const AipifySidebarTypography = {
  ...
  workspaceSummaryLabel: "shrink-0 text-xs font-medium leading-snug text-aipify-text-secondary",
  ...
  workspaceSummaryFooter: "text-xs font-semibold leading-snug text-aipify-text",
