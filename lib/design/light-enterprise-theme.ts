...
export const AipifyShellClasses = {
  ...
  pageTitle: "text-[1.5625rem] font-semibold leading-tight tracking-tight text-aipify-text sm:text-[1.625rem]",
  pageSubtitle: "mt-1.5 text-sm leading-relaxed text-aipify-text-secondary",
...
export const AipifySidebarTypography = {
  workspaceTitle: "text-base font-bold leading-snug text-aipify-text line-clamp-2",
  workspaceDescription:
    "text-[13px] font-medium leading-snug text-aipify-text-secondary line-clamp-2",
  searchMenuRow: "text-[13px] font-medium leading-snug text-aipify-text",
  ...
  mobileNavItem: "text-[13px] font-semibold leading-snug",
  mobileNavLabel: "min-w-0 max-w-[5.25rem] break-words text-center text-[12px] leading-snug line-clamp-2",
  navLabelWrap: "block break-words leading-snug line-clamp-2",
  navItemRow:
    "flex w-full min-h-10 items-start gap-2.5 rounded-xl px-3 py-2 text-left transition focus:outline-none focus-visible:ring-2 focus-visible:ring-aipify-focus focus-visible:ring-offset-2",
  navIcon: "size-[18px] shrink-0",
