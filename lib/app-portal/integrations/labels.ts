...
function buildInstallationWizardMessageCatalog(t: Translator): Record<string, string> {
  ...
  const suffixes = [
    ...
    "preview.badge",
    "preview.notice",
    "preview.readOnlyAction",
    "preview.close",
    "preview.sampleCredential",
    "preview.actionsExampleHeading",
    "preview.actionsUnavailable",
    "preview.status.choose",
    "preview.status.aipifyManaged",
    "preview.status.guided",
    "preview.status.selfService",
    "preview.status.customerItManaged",
    "preview.responsibility.choose",
    "preview.responsibility.aipifyManaged",
    "preview.responsibility.guided",
    "preview.responsibility.selfService",
    "preview.responsibility.customerItManaged",
    "install.actionsChooseHint",
    "install.actionsHeading",
    "install.sessionPersistError",
    "install.primaryActions.aipifyManaged",
    "install.primaryActions.guided",
    "install.primaryActions.selfService",
    "install.primaryActions.customerItManaged",
    "install.status.choose",
    "install.status.aipifyManaged",
    "install.status.guided",
    "install.status.selfService",
    "install.status.customerItManaged",
    "install.responsibility.choose",
    "install.responsibility.aipifyManaged",
    "install.responsibility.guided",
    "install.responsibility.selfService",
    "install.responsibility.customerItManaged",
    "install.statusAfterHandoff.guided",
    "handoff.submitting",
    "handoff.failed",
    "handoff.invalidRecipient",
    "handoff.nextStepHint",
    "handoff.referenceLabel",
    "handoff.requestedAtLabel",
    "handoff.recipientLabel",
    "handoff.itRecipientPlaceholder",
    "handoff.success.aipifyManaged",
    "handoff.success.guided",
    "handoff.success.customerItManaged",
    "handoff.success.duplicate",
  ...
  return {
    hub: {
      ...
      actions: {
        ...
        previewWizard: t(`${ha}.previewWizard`),
      },
      removeDialog: {
        title: t(`${hd}.title`),
        body: t(`${hd}.body`),
