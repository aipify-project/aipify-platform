...
const RULES: IntentRule[] = [
  {
    ...
    summary: "This request asks for a critical change that Kompis cannot execute yet.",
    patterns: [
      /slett\s+(hele\s+)?(nettsted|nettsid|website|site)/i,
      /delete\s+(the\s+)?(entire\s+)?(website|site|all\s+pages)/i,
      /betal/i,
      /payment/i,
      /stripe/i,
      /fiken/i,
  ...
  {
    intent: "website_seo_audit",
    title: "Website SEO audit",
    summary: "Review SEO findings from website drafts and delivery context.",
    patterns: [/seo/i, /metabeskriv/i, /meta\s*description/i, /sidetittel/i, /canonical/i],
    tools: ["website_overview_read", "website_seo_audit", "website_pages_read"],
  },
  {
    intent: "website_locale_coverage",
    title: "Website locale coverage",
    summary: "Check language coverage for website drafts.",
    patterns: [/språkdekning/i, /locale\s*coverage/i, /mangler.*oversett/i, /missing.*translation/i, /svensk\s*oversett/i],
    tools: ["website_locale_coverage_read", "website_pages_read"],
  },
  {
    intent: "website_page_draft",
    title: "Create website page draft",
    summary: "Create a website page draft without publishing.",
    patterns: [/utkast.*side/i, /page\s*draft/i, /om\s*oss/i, /about\s*us/i, /ny\s+.*side/i],
    tools: ["website_page_draft_create"],
  },
  {
    intent: "website_seo_draft",
    title: "Create website SEO draft",
    summary: "Create an SEO metadata draft without publishing.",
    patterns: [/seo.*utkast/i, /utkast.*seo/i, /meta.*utkast/i, /seo\s*draft/i],
    tools: ["website_seo_draft_update"],
  },
  {
    intent: "website_translation_draft",
    title: "Create website translation draft",
    summary: "Create a translation draft for an active locale without publishing.",
    patterns: [/oversettelsesutkast/i, /translation\s*draft/i, /dansk\s*utkast/i, /svensk\s*utkast/i],
    tools: ["website_translation_draft_create"],
  },
  {
    intent: "website_navigation_draft",
    title: "Create navigation draft",
    summary: "Prepare a navigation draft that requires approval and stays unpublished.",
    patterns: [/navigasjonsutkast/i, /navigation\s*draft/i, /menyutkast/i],
    tools: ["website_navigation_draft_update"],
  },
  {
    intent: "website_overview",
    title: "Website overview",
    summary: "Review website delivery, domain, installation, drafts, and runtime health.",
    patterns: [/nettsted/i, /website/i, /nettsid/i, /kontroller\s+nettsted/i],
    tools: [
