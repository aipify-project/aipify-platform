...
export function buildActionDefinitionFromCommerceCapability(
  capability: import("./companion-commerce-context").CommerceCapabilityRuntimeRef,
  options: {
    permissionAllowed: boolean;
    appEntitlementBlocked: boolean;
    emergencyStop: boolean;
...
export function buildActionDefinitionFromServicesCapability(
  capability: import("./companion-services-context").ServicesCapabilityRuntimeRef,
  options: {
    permissionAllowed: boolean;
    appEntitlementBlocked: boolean;
    emergencyStop: boolean;
  ...
  return {
    ...
    input_schema: buildWriteInputSchema(capability.capability_id),
    expected_result_schema: buildExpectedResultSchema(),
    source: "services_provider",
    enabled,
  };
}

export function buildActionDefinitionFromSupportCapability(
  capability: import("./companion-support-context").SupportCapabilityRuntimeRef,
  options: {
    permissionAllowed: boolean;
    appEntitlementBlocked: boolean;
    emergencyStop: boolean;
...
export function buildActionDefinitionFromHostsCapability(
  capability: import("./companion-hosts-context").HostsCapabilityRuntimeRef,
  options: {
    permissionAllowed: boolean;
    appEntitlementBlocked: boolean;
    emergencyStop: boolean;
  ...
  return {
    ...
    input_schema: buildWriteInputSchema(capability.capability_id),
    expected_result_schema: buildExpectedResultSchema(),
    source: "hosts_provider",
    enabled,
  };
}

export function buildActionDefinitionFromHrCapability(
  capability: import("./companion-hr-context").HrCapabilityRuntimeRef,
  options: {
    permissionAllowed: boolean;
    appEntitlementBlocked: boolean;
    emergencyStop: boolean;
...
export function buildActionDefinitionFromWarehouseCapability(
  capability: import("./companion-warehouse-context").WarehouseCapabilityRuntimeRef,
  options: {
    permissionAllowed: boolean;
    appEntitlementBlocked: boolean;
    emergencyStop: boolean;
  ...
  return {
    ...
    input_schema: buildWriteInputSchema(capability.capability_id),
    expected_result_schema: buildExpectedResultSchema(),
    source: "warehouse_provider",
    enabled,
  };
}

export function buildActionDefinitionFromFinanceCapability(
  capability: import("./companion-finance-context").FinanceCapabilityRuntimeRef,
  options: {
    permissionAllowed: boolean;
    appEntitlementBlocked: boolean;
    emergencyStop: boolean;
  ...
  return {
    ...
    input_schema: buildWriteInputSchema(capability.capability_id),
    expected_result_schema: buildExpectedResultSchema(),
    source: "finance_provider",
    enabled,
  };
}

export function buildActionDefinitionFromSalesCapability(
  capability: import("./companion-sales-context").SalesCapabilityRuntimeRef,
  options: {
    permissionAllowed: boolean;
    appEntitlementBlocked: boolean;
    emergencyStop: boolean;
...
export function buildActionDefinitionFromCommunityCapability(
  capability: import("./companion-community-context").CommunityCapabilityRuntimeRef,
  options: {
    permissionAllowed: boolean;
    appEntitlementBlocked: boolean;
    emergencyStop: boolean;
