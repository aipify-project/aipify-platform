...
export const SUPPORT_PROVIDER_MANIFESTS: readonly SupportProviderManifest[] = [
  {
    ...
    capabilities: [
      readCapability("support_queue.read", "support_queue"),
      readCapability("support_case.read", "support_case"),
      readCapability("support_case_status.read", "support_case"),
      readCapability("support_assignment.read", "support_case"),
      readCapability("support_sla.read", "sla", SUPPORT_METRICS),
      readCapability("support_escalation.read", "escalation"),
      readCapability("support_metrics.read", "insight", SUPPORT_METRICS),
      ...
      writeCapability("support_response.draft", "response", SUPPORT_REPLY),
      writeCapability("support_case.assign", "support_case", SUPPORT_ASSIGN),
      writeCapability("support_case.escalate", "escalation", SUPPORT_ESCALATE),
  ...
  },
  {
    ...
    capabilities: [
      readCapability("support_queue.read", "support_queue", null),
      readCapability("support_case.read", "support_case", null),
      readCapability("support_case_status.read", "support_case", null),
      readCapability("support_assignment.read", "support_case", null),
      readCapability("support_sla.read", "sla", SUPPORT_METRICS),
      readCapability("support_escalation.read", "escalation", null),
      readCapability("support_metrics.read", "insight", SUPPORT_METRICS),
