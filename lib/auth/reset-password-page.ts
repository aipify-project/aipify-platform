...
export function getResetPasswordFormLabels(t: AuthTranslator) {
  return {
    ...
    linkExpired: t("auth.resetPassword.errors.linkExpired"),
    linkInvalid: t("auth.resetPassword.errors.linkInvalid"),
    callbackFailed: t("auth.resetPassword.errors.callbackFailed"),
