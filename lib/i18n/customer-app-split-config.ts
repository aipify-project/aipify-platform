...
const MARKETPLACE_PATTERN =
  /^(marketplace|skillStore|skillsMarketplace|moduleMarketplace|appEcosystem|businessPackMarketplace|companionMarketplace|globalEcosystemMarketplace|commerceCompanion|appStore|licenseDashboard)/;
