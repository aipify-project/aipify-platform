...
export function parseFooterGovernanceLabels(marketing: MarketingDictionary) {
  ...
  return {
    ...
    organizationNumber: footer.organizationNumber ?? "",
    supportEmail: footer.supportEmail ?? "",
    resources: footer.resources ?? footer.knowledge ?? "Resources",
    partners: footer.partners ?? footer.growthPartners ?? "Partners",
