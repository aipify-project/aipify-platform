...
export function buildSystemNoticeLabels(t: Translator): SystemNoticeLabels {
  ...
  return {
    ...
    registerGrowthPartnerAccount: t(`${p}.registerGrowthPartnerAccount`),
    returnToDashboard: t(`${p}.returnToDashboard`),
    viewBusinessPacks: t(`${p}.viewBusinessPacks`),
    upgradePlan: t(`${p}.upgradePlan`),
    upgradeToEnterprise: t(`${p}.upgradeToEnterprise`),
    ...
    presets: {
      ...
      business_pack_required: preset("business_pack_required"),
      professional_plan_required: preset("professional_plan_required"),
      enterprise_access_required: preset("enterprise_access_required"),
      administrator_access_required: preset("administrator_access_required"),
      executive_access_required: preset("executive_access_required"),
