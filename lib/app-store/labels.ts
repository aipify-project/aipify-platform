...
export function buildAppStoreLabels(t: Translator) {
  ...
  return {
    ...
    catalogPendingTitle: t(`${p}.catalogPendingTitle`),
    catalogPendingDescription: t(`${p}.catalogPendingDescription`),
    loadErrorTitle: t(`${p}.loadErrorTitle`),
    loadErrorBody: t(`${p}.loadErrorBody`),
    retry: t(`${p}.retry`),
