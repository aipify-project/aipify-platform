-- Phase 620 P1 — make get_app_organization_context() read-only for GET /api/app/organization-context.
-- Removes provisioning/sync writes that fail under read-only transactions.
