-- Phase 620 P1 — Executive Command Center GET must be read-only.
...
-- Provision baseline executive command center metadata outside the GET path.
do $$
declare
  v_org_id uuid;
begin
  for v_org_id in select id from public.customers loop
