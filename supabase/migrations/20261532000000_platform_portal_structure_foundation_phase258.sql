-- Phase 258 — PLATFORM Portal Structure Foundation
...
begin
  ...
  v_growth_partners := jsonb_build_object(
    'active_programs', 1,
  ...
  return jsonb_build_object(
    'principle', 'Operational heartbeat for Aipify Group AS — daily operations, not customer-facing APP workflows.',
    'organizations_requiring_attention', v_orgs_attention,
    ...
    'growth_partner_summary', v_growth_partners,
