...
export default async function PlatformTranslationManagementPage() {
  ...
  return (
    <PlatformPortalFoundationPanel
      title={t("platform.portalStructure.translationManagement.title")}
      subtitle={t("platform.portalStructure.translationManagement.subtitle")}
