...
export default async function PlatformDocumentationPage() {
  ...
  return (
    <PlatformPortalFoundationPanel
      title={t("platform.portalStructure.documentation.title")}
      subtitle={t("platform.portalStructure.documentation.subtitle")}
