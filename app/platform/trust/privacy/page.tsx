...
export default async function TrustPrivacyPage() {
  ...
  if (!canAccessTrustDomain("privacy", profile?.role)) {
  ...
  return (
    <>
      <TrustDomainPageHeader
        title={t("platform.trustCenter.domains.privacy.title")}
        subtitle={t("platform.trustCenter.pageSubtitles.privacy")}
      />
      <PlatformTrustScaffold
        title={t("platform.trust.title")}
        subtitle={t("platform.trust.subtitle")}
        responsibility={t("platform.trustCenter.privacyDetail.responsibility")}
        areas={[
          t("platform.trustCenter.privacyDetail.areas.dataMinimization"),
          t("platform.trustCenter.privacyDetail.areas.customerOwnership"),
          t("platform.trustCenter.privacyDetail.areas.metadataOnly"),
          t("platform.trustCenter.privacyDetail.areas.regulatoryCompliance"),
        ]}
      />
      <PlatformAssistantMemoryPanel labels={labels.assistantMemory} />
    </>
  );
}
