...
export default async function TrustIdentityPage() {
  ...
  if (!canAccessTrustDomain("identity", profile?.role)) {
  ...
  return (
    <>
      <TrustDomainPageHeader
        title={t("platform.trustCenter.domains.identity.title")}
        subtitle={t("platform.trustCenter.pageSubtitles.identity")}
      />
      <PlatformIdentityPanel labels={labels.identity} />
