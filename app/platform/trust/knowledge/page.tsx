...
export default async function TrustKnowledgePage() {
  ...
  if (!canAccessTrustDomain("knowledge", profile?.role)) {
  ...
  return (
    <>
      <TrustDomainPageHeader
        title={t("platform.trustCenter.domains.knowledge.title")}
        subtitle={t("platform.trustCenter.pageSubtitles.knowledge")}
      />
      <PlatformEmployeeKnowledgePanel labels={labels.employeeKnowledge} />
      <PlatformBusinessDnaPanel labels={labels.businessDna} />
      <PlatformSupportOperationsPanel labels={labels.supportOperations} />
    </>
  );
}
