...
export default async function TrustRelationshipsPage() {
  ...
  if (!canAccessTrustDomain("relationships", profile?.role)) {
  ...
  return (
    <>
      <TrustDomainPageHeader
        title={t("platform.trustCenter.domains.relationships.title")}
        subtitle={t("platform.trustCenter.pageSubtitles.relationships")}
      />
      <PlatformRelationshipPanel labels={labels.relationships} />
    </>
  );
}
