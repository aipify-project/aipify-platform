...
export default async function TrustCommercialPage() {
  ...
  if (!canAccessTrustDomain("commercial", profile?.role)) {
  ...
  return (
    <>
      <TrustDomainPageHeader
        title={t("platform.trustCenter.domains.commercial.title")}
        subtitle={t("platform.trustCenter.pageSubtitles.commercial")}
      />
      <PlatformCommercialPackagesPanel labels={labels.commercialPackages} />
    </>
  );
}
