...
export default async function TrustGoalsPage() {
  ...
  if (!canAccessTrustDomain("goals", profile?.role)) {
  ...
  return (
    <>
      <TrustDomainPageHeader
        title={t("platform.trustCenter.domains.goals.title")}
        subtitle={t("platform.trustCenter.pageSubtitles.goals")}
      />
      <PlatformGoalsPanel labels={labels.goalsDreams} />
    </>
  );
}
