...
export default async function TrustActionsPage() {
  ...
  if (!canAccessTrustDomain("actions", profile?.role)) {
  ...
  return (
    <>
      <TrustDomainPageHeader
        title={t("platform.trustCenter.domains.actions.title")}
        subtitle={t("platform.trustCenter.pageSubtitles.actions")}
      />
      <PlatformTrustActionsPanel labels={labels.trustActions} />
      <PlatformAefPanel labels={labels.aef} />
    </>
  );
}
