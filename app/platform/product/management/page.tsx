...
export default async function PlatformProductManagementPage() {
  ...
  return (
    <PlatformPortalFoundationPanel
      title={t("platform.portalStructure.productManagement.title")}
      subtitle={t("platform.portalStructure.productManagement.subtitle")}
