...
export default async function PlatformBusinessPacksPage() {
  ...
  return (
    <PlatformPortalFoundationPanel
      title={t("platform.portalStructure.businessPacks.title")}
      subtitle={t("platform.portalStructure.businessPacks.subtitle")}
