...
export default async function PlatformBillingLicensePurchasesPage() {
  ...
  return (
    <BillingCommerceSectionPanel
      ...
      title={labels.modules.licensePurchases}
      subtitle={labels.moduleDescriptions.licensePurchases}
      labels={labels}
    />
  );
}
