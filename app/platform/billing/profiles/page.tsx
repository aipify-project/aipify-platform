...
export default async function PlatformBillingProfilesPage() {
  ...
  return (
    <BillingPanel
      labels={{
        title: t("platform.billingCommerceCenter.modules.billingProfiles"),
        subtitle: t("platform.billingCommerceCenter.moduleDescriptions.billingProfiles"),
