...
export default async function PlatformOperationsOverviewPage() {
  ...
  return (
    <PlatformOverviewPanel
      ...
      labels={{
        title: t("platform.portalStructure.operationsOverview.title"),
        subtitle: t("platform.portalStructure.operationsOverview.subtitle"),
