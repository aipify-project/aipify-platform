import { SharedCompassionReciprocalCareEngineDashboardPanel } from "@/components/app/shared-compassion-reciprocal-care-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function SharedCompassionReciprocalCareEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "sharedCompassionReciprocalCareEngine");
  const t = createTranslator(dict);
  const p = "customerApp.sharedCompassionReciprocalCareEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <SharedCompassionReciprocalCareEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
