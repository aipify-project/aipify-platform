import { AipifyOrganizationalGoalsAlignmentEngineDashboardPanel } from "@/components/app/aipify-organizational-goals-alignment-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyOrganizationalGoalsAlignmentEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyOrganizationalGoalsAlignmentEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyOrganizationalGoalsAlignmentEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyOrganizationalGoalsAlignmentEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
