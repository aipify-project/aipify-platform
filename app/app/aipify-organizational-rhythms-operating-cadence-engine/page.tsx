import { AipifyOrganizationalRhythmsOperatingCadenceEngineDashboardPanel } from "@/components/app/aipify-organizational-rhythms-operating-cadence-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyOrganizationalRhythmsOperatingCadenceEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyOrganizationalRhythmsOperatingCadenceEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyOrganizationalRhythmsOperatingCadenceEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyOrganizationalRhythmsOperatingCadenceEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
