...
export default async function ExecutionActionsPage() {
  ...
  return (
    <ExecutionOperationsPanel
      labels={labels}
      initialTab="overview"
      titleOverride={labels.actionsTitle}
      subtitleOverride={labels.actionsSubtitle}
      visibleTabs={["overview", "pending_actions", "approved_actions", "execution_history", "permissions", "approvals"]}
    />
  );
}
