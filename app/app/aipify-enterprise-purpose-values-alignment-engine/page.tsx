import { AipifyEnterprisePurposeValuesAlignmentEngineDashboardPanel } from "@/components/app/aipify-enterprise-purpose-values-alignment-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterprisePurposeValuesAlignmentEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterprisePurposeValuesAlignmentEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterprisePurposeValuesAlignmentEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterprisePurposeValuesAlignmentEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
