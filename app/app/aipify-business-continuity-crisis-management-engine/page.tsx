import { AipifyBusinessContinuityCrisisManagementEngineDashboardPanel } from "@/components/app/aipify-business-continuity-crisis-management-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyBusinessContinuityCrisisManagementEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyBusinessContinuityCrisisManagementEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyBusinessContinuityCrisisManagementEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyBusinessContinuityCrisisManagementEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
