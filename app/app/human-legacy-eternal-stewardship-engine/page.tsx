import { HumanLegacyEternalStewardshipEngineDashboardPanel } from "@/components/app/human-legacy-eternal-stewardship-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function HumanLegacyEternalStewardshipEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "humanLegacyEternalStewardshipEngine");
  const t = createTranslator(dict);
  const p = "customerApp.humanLegacyEternalStewardshipEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <HumanLegacyEternalStewardshipEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
