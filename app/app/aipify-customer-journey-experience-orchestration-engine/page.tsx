import { AipifyCustomerJourneyExperienceOrchestrationEngineDashboardPanel } from "@/components/app/aipify-customer-journey-experience-orchestration-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyCustomerJourneyExperienceOrchestrationEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyCustomerJourneyExperienceOrchestrationEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyCustomerJourneyExperienceOrchestrationEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyCustomerJourneyExperienceOrchestrationEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
