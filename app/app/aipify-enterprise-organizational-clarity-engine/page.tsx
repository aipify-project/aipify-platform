import { AipifyEnterpriseOrganizationalClarityEngineDashboardPanel } from "@/components/app/aipify-enterprise-organizational-clarity-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseOrganizationalClarityEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseOrganizationalClarityEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseOrganizationalClarityEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseOrganizationalClarityEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
