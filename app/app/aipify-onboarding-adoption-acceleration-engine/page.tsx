import { AipifyOnboardingAdoptionAccelerationEngineDashboardPanel } from "@/components/app/aipify-onboarding-adoption-acceleration-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyOnboardingAdoptionAccelerationEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyOnboardingAdoptionAccelerationEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyOnboardingAdoptionAccelerationEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyOnboardingAdoptionAccelerationEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
