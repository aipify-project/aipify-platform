import { AipifyDecisionTransparencyEngineDashboardPanel } from "@/components/app/aipify-decision-transparency-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyDecisionTransparencyEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyDecisionTransparencyEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyDecisionTransparencyEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyDecisionTransparencyEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
