import { AipifyEnterpriseResilienceBusinessContinuityEngineDashboardPanel } from "@/components/app/aipify-enterprise-resilience-business-continuity-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseResilienceBusinessContinuityEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseResilienceBusinessContinuityEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseResilienceBusinessContinuityEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseResilienceBusinessContinuityEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
