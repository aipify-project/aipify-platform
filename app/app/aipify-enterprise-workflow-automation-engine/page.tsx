import { AipifyEnterpriseWorkflowAutomationEngineDashboardPanel } from "@/components/app/aipify-enterprise-workflow-automation-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseWorkflowAutomationEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseWorkflowAutomationEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseWorkflowAutomationEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseWorkflowAutomationEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
