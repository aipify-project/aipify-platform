import { AipifyDigitalHeadquartersEngineDashboardPanel } from "@/components/app/aipify-digital-headquarters-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyDigitalHeadquartersEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyDigitalHeadquartersEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyDigitalHeadquartersEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyDigitalHeadquartersEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
