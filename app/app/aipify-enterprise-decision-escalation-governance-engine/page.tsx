import { AipifyEnterpriseDecisionEscalationGovernanceEngineDashboardPanel } from "@/components/app/aipify-enterprise-decision-escalation-governance-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseDecisionEscalationGovernanceEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseDecisionEscalationGovernanceEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseDecisionEscalationGovernanceEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseDecisionEscalationGovernanceEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
