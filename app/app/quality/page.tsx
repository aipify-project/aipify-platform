  ...
  return (
    <QualityDashboardPanel
      ...
      labels={{
        ...
        images: t("customerApp.quality.images.nav"),
        performance: t("customerApp.quality.performance.nav"),
        mobile: t("customerApp.quality.mobile.nav"),
        ...
        healthScore: t("customerApp.quality.healthScore"),
        ...
        imageIssues: t("customerApp.quality.widgets.imageIssues"),
        performanceIssues: t("customerApp.quality.widgets.performanceIssues"),
        mobileIssues: t("customerApp.quality.widgets.mobileIssues"),
        brokenLinks: t("customerApp.quality.widgets.brokenLinks"),
        missingTranslations: t("customerApp.quality.widgets.missingTranslations"),
