...
export default async function OrganizationWorkspaceEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "organizationWorkspaceEngine");
    ...
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <OrganizationWorkspaceEngineDashboardPanel
        labels={{
          ...
          hierarchyCompanion: t(`${p}.hierarchyCompanion`),
          successCriteria: t(`${p}.successCriteria`),
          companionFoundation: t(`${p}.companionFoundation`),
          companionFoundationNote: t(`${p}.companionFoundationNote`),
          bellMoments: t(`${p}.bellMoments`),
          selfLoveReminders: t(`${p}.selfLoveReminders`),
          recognitionFeatures: t(`${p}.recognitionFeatures`),
          presenceComfort: t(`${p}.presenceComfort`),
          enabled: t(`${p}.enabled`),
          disabled: t(`${p}.disabled`),
          companionSaveFailed: t(`${p}.companionSaveFailed`),
