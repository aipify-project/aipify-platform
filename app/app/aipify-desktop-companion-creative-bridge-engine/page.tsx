import { AipifyDesktopCompanionCreativeBridgeEngineDashboardPanel } from "@/components/app/aipify-desktop-companion-creative-bridge-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyDesktopCompanionCreativeBridgeEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyDesktopCompanionCreativeBridgeEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyDesktopCompanionCreativeBridgeEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyDesktopCompanionCreativeBridgeEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
