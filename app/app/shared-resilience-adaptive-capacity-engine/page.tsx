import { SharedResilienceAdaptiveCapacityEngineDashboardPanel } from "@/components/app/shared-resilience-adaptive-capacity-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function SharedResilienceAdaptiveCapacityEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "sharedResilienceAdaptiveCapacityEngine");
  const t = createTranslator(dict);
  const p = "customerApp.sharedResilienceAdaptiveCapacityEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <SharedResilienceAdaptiveCapacityEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
