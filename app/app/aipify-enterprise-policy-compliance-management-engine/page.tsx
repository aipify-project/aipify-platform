import { AipifyEnterprisePolicyComplianceManagementEngineDashboardPanel } from "@/components/app/aipify-enterprise-policy-compliance-management-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterprisePolicyComplianceManagementEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterprisePolicyComplianceManagementEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterprisePolicyComplianceManagementEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterprisePolicyComplianceManagementEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
