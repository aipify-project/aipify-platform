import { SharedGratitudeAppreciativeStewardshipEngineDashboardPanel } from "@/components/app/shared-gratitude-appreciative-stewardship-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function SharedGratitudeAppreciativeStewardshipEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "sharedGratitudeAppreciativeStewardshipEngine");
  const t = createTranslator(dict);
  const p = "customerApp.sharedGratitudeAppreciativeStewardshipEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <SharedGratitudeAppreciativeStewardshipEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
