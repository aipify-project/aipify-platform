import { AipifyValuesTransmissionCulturalContinuityEngineDashboardPanel } from "@/components/app/aipify-values-transmission-cultural-continuity-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyValuesTransmissionCulturalContinuityEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyValuesTransmissionCulturalContinuityEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyValuesTransmissionCulturalContinuityEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyValuesTransmissionCulturalContinuityEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
