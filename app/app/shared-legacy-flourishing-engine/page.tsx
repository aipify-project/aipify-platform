import { SharedLegacyFlourishingEngineDashboardPanel } from "@/components/app/shared-legacy-flourishing-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function SharedLegacyFlourishingEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "sharedLegacyFlourishingEngine");
  const t = createTranslator(dict);
  const p = "customerApp.sharedLegacyFlourishingEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <SharedLegacyFlourishingEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
