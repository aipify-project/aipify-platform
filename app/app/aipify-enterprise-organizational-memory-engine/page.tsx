import { AipifyEnterpriseOrganizationalMemoryEngineDashboardPanel } from "@/components/app/aipify-enterprise-organizational-memory-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseOrganizationalMemoryEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseOrganizationalMemoryEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseOrganizationalMemoryEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseOrganizationalMemoryEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
