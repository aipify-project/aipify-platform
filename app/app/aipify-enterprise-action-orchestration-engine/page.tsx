import { AipifyEnterpriseActionOrchestrationEngineDashboardPanel } from "@/components/app/aipify-enterprise-action-orchestration-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseActionOrchestrationEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseActionOrchestrationEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseActionOrchestrationEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseActionOrchestrationEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
