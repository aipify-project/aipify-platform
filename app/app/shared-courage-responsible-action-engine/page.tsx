import { SharedCourageResponsibleActionEngineDashboardPanel } from "@/components/app/shared-courage-responsible-action-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function SharedCourageResponsibleActionEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "sharedCourageResponsibleActionEngine");
  const t = createTranslator(dict);
  const p = "customerApp.sharedCourageResponsibleActionEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <SharedCourageResponsibleActionEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
