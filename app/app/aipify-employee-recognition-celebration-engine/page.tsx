import { AipifyEmployeeRecognitionCelebrationEngineDashboardPanel } from "@/components/app/aipify-employee-recognition-celebration-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEmployeeRecognitionCelebrationEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEmployeeRecognitionCelebrationEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEmployeeRecognitionCelebrationEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEmployeeRecognitionCelebrationEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
