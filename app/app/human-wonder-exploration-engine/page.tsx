import { HumanWonderExplorationEngineDashboardPanel } from "@/components/app/human-wonder-exploration-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function HumanWonderExplorationEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "humanWonderExplorationEngine");
  const t = createTranslator(dict);
  const p = "customerApp.humanWonderExplorationEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <HumanWonderExplorationEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
