import { AipifyEnterpriseGovernancePolicyAutomationEngineDashboardPanel } from "@/components/app/aipify-enterprise-governance-policy-automation-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseGovernancePolicyAutomationEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseGovernancePolicyAutomationEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseGovernancePolicyAutomationEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseGovernancePolicyAutomationEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
