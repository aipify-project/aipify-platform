import { AipifyEnterpriseIntegrationHubEngineDashboardPanel } from "@/components/app/aipify-enterprise-integration-hub-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseIntegrationHubEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseIntegrationHubEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseIntegrationHubEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseIntegrationHubEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
