import { AipifyEnterpriseOrganizationalAdaptabilityEngineDashboardPanel } from "@/components/app/aipify-enterprise-organizational-adaptability-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseOrganizationalAdaptabilityEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseOrganizationalAdaptabilityEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseOrganizationalAdaptabilityEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseOrganizationalAdaptabilityEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
