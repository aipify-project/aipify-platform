import { AipifyConstitutionPerpetualPrinciplesEngineDashboardPanel } from "@/components/app/aipify-constitution-perpetual-principles-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyConstitutionPerpetualPrinciplesEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyConstitutionPerpetualPrinciplesEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyConstitutionPerpetualPrinciplesEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyConstitutionPerpetualPrinciplesEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
