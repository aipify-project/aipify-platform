import { AipifyEnterpriseTrustRelationshipIntelligenceEngineDashboardPanel } from "@/components/app/aipify-enterprise-trust-relationship-intelligence-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseTrustRelationshipIntelligenceEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseTrustRelationshipIntelligenceEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseTrustRelationshipIntelligenceEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseTrustRelationshipIntelligenceEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
