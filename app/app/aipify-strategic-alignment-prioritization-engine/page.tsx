import { AipifyStrategicAlignmentPrioritizationEngineDashboardPanel } from "@/components/app/aipify-strategic-alignment-prioritization-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyStrategicAlignmentPrioritizationEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyStrategicAlignmentPrioritizationEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyStrategicAlignmentPrioritizationEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyStrategicAlignmentPrioritizationEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
