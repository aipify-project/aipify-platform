...
export default async function HeadquartersWarRoomPage() {
  ...
  return (
    <HeadquartersPanel
      ...
      visibleTabs={["operations_room", "live_activity", "approvals", "alerts", "companion"]}
      titleOverride={labels.warRoomTitle}
      labels={labels}
      showWarRoom
    />
  );
