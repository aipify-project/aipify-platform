import { AipifyEnterpriseActionPrioritizationFocusEngineDashboardPanel } from "@/components/app/aipify-enterprise-action-prioritization-focus-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseActionPrioritizationFocusEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseActionPrioritizationFocusEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseActionPrioritizationFocusEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseActionPrioritizationFocusEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
