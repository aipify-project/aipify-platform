...
export default async function PurposeValuesEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "purposeValuesEngine");
    ...
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <PurposeValuesEngineDashboardPanel
        labels={{
          ...
          phase156Objectives: t(`${p}.phase156.objectives`),
          phase156RenewalCenter: t(`${p}.phase156.renewalCenter`),
          phase156PurposeEvolution: t(`${p}.phase156.purposeEvolution`),
          phase156ValuesContinuity: t(`${p}.phase156.valuesContinuity`),
          phase156IdentityEvolution: t(`${p}.phase156.identityEvolution`),
          phase156PurposeCompanion: t(`${p}.phase156.purposeCompanion`),
          phase156CulturalContinuity: t(`${p}.phase156.culturalContinuity`),
          phase156PurposeMemory: t(`${p}.phase156.purposeMemory`),
          phase156ExecutiveReviews: t(`${p}.phase156.executiveReviews`),
          phase156CompanionLimitations: t(`${p}.phase156.companionLimitations`),
          phase156SelfLoveConnection: t(`${p}.phase156.selfLoveConnection`),
          phase156Engagement: t(`${p}.phase156.engagementSummary`),
          phase156RenewalReviews: t(`${p}.phase156.renewalReviews`),
          phase156EvolutionWorkshops: t(`${p}.phase156.evolutionWorkshops`),
          phase156PurposeMemoryCount: t(`${p}.phase156.purposeMemoryCount`),
          phase156ContinuityRecords: t(`${p}.phase156.continuityRecords`),
          phase156SuccessCriteria: t(`${p}.phase156.successCriteria`),
          phase156VisionPhrases: t(`${p}.phase156.visionPhrases`),
        }}
      />
    </div>
  );
