  ...
  return (
    <AssistantChatPanel
      ...
      labels={{
        ...
        confirmFocus: t("customerApp.assistant.confirmFocus"),
        viewAttention: t("customerApp.assistant.viewAttention"),
        viewDecisions: t("customerApp.assistant.viewDecisions"),
