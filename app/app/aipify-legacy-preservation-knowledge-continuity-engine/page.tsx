import { AipifyLegacyPreservationKnowledgeContinuityEngineDashboardPanel } from "@/components/app/aipify-legacy-preservation-knowledge-continuity-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyLegacyPreservationKnowledgeContinuityEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyLegacyPreservationKnowledgeContinuityEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyLegacyPreservationKnowledgeContinuityEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyLegacyPreservationKnowledgeContinuityEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
