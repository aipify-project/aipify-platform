import { HumanHopePossibilityEngineDashboardPanel } from "@/components/app/human-hope-possibility-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function HumanHopePossibilityEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "humanHopePossibilityEngine");
  const t = createTranslator(dict);
  const p = "customerApp.humanHopePossibilityEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <HumanHopePossibilityEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
