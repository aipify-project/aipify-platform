import { AipifyDecisionCenterGovernanceEngineDashboardPanel } from "@/components/app/aipify-decision-center-governance-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyDecisionCenterGovernanceEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyDecisionCenterGovernanceEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyDecisionCenterGovernanceEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyDecisionCenterGovernanceEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
