import { AipifyPerformanceGoalAlignmentEngineDashboardPanel } from "@/components/app/aipify-performance-goal-alignment-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyPerformanceGoalAlignmentEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyPerformanceGoalAlignmentEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyPerformanceGoalAlignmentEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyPerformanceGoalAlignmentEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
