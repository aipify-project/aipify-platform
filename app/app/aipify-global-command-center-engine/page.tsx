import { AipifyGlobalCommandCenterEngineDashboardPanel } from "@/components/app/aipify-global-command-center-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyGlobalCommandCenterEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyGlobalCommandCenterEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyGlobalCommandCenterEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyGlobalCommandCenterEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
