import { AipifyContinuousImprovementOptimizationEngineDashboardPanel } from "@/components/app/aipify-continuous-improvement-optimization-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyContinuousImprovementOptimizationEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "continuousImprovementOptimizationEngine");
  const t = createTranslator(dict);
  const p = "customerApp.continuousImprovementOptimizationEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyContinuousImprovementOptimizationEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
