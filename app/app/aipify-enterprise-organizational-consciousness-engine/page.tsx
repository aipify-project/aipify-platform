import { AipifyEnterpriseOrganizationalConsciousnessEngineDashboardPanel } from "@/components/app/aipify-enterprise-organizational-consciousness-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseOrganizationalConsciousnessEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseOrganizationalConsciousnessEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseOrganizationalConsciousnessEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseOrganizationalConsciousnessEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
