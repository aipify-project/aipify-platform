import { AipifyEnterpriseSearchUniversalKnowledgeAccessEngineDashboardPanel } from "@/components/app/aipify-enterprise-search-universal-knowledge-access-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseSearchUniversalKnowledgeAccessEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseSearchUniversalKnowledgeAccessEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseSearchUniversalKnowledgeAccessEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseSearchUniversalKnowledgeAccessEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
