import { AipifyInnovationIdeaManagementEngineDashboardPanel } from "@/components/app/aipify-innovation-idea-management-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyInnovationIdeaManagementEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyInnovationIdeaManagementEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyInnovationIdeaManagementEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyInnovationIdeaManagementEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
