import { AipifyWellbeingSustainablePerformanceEngineDashboardPanel } from "@/components/app/aipify-wellbeing-sustainable-performance-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyWellbeingSustainablePerformanceEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyWellbeingSustainablePerformanceEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyWellbeingSustainablePerformanceEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyWellbeingSustainablePerformanceEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
