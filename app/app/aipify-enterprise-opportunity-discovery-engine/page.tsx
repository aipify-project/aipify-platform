import { AipifyEnterpriseOpportunityDiscoveryEngineDashboardPanel } from "@/components/app/aipify-enterprise-opportunity-discovery-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseOpportunityDiscoveryEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseOpportunityDiscoveryEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseOpportunityDiscoveryEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseOpportunityDiscoveryEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
