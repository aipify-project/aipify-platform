import { AipifyEnterpriseNotificationAttentionManagementEngineDashboardPanel } from "@/components/app/aipify-enterprise-notification-attention-management-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseNotificationAttentionManagementEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseNotificationAttentionManagementEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseNotificationAttentionManagementEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseNotificationAttentionManagementEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
