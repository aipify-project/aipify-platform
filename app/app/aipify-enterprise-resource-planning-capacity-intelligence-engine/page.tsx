import { AipifyEnterpriseResourcePlanningCapacityIntelligenceEngineDashboardPanel } from "@/components/app/aipify-enterprise-resource-planning-capacity-intelligence-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseResourcePlanningCapacityIntelligenceEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseResourcePlanningCapacityIntelligenceEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseResourcePlanningCapacityIntelligenceEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseResourcePlanningCapacityIntelligenceEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
