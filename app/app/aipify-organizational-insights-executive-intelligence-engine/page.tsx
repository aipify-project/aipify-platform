import { AipifyOrganizationalInsightsExecutiveIntelligenceEngineDashboardPanel } from "@/components/app/aipify-organizational-insights-executive-intelligence-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyOrganizationalInsightsExecutiveIntelligenceEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyOrganizationalInsightsExecutiveIntelligenceEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyOrganizationalInsightsExecutiveIntelligenceEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyOrganizationalInsightsExecutiveIntelligenceEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
