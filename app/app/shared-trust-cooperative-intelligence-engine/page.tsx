import { SharedTrustCooperativeIntelligenceEngineDashboardPanel } from "@/components/app/shared-trust-cooperative-intelligence-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function SharedTrustCooperativeIntelligenceEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "sharedTrustCooperativeIntelligenceEngine");
  const t = createTranslator(dict);
  const p = "customerApp.sharedTrustCooperativeIntelligenceEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <SharedTrustCooperativeIntelligenceEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
