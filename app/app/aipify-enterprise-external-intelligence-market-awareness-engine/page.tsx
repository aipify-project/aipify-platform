import { AipifyEnterpriseExternalIntelligenceMarketAwarenessEngineDashboardPanel } from "@/components/app/aipify-enterprise-external-intelligence-market-awareness-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseExternalIntelligenceMarketAwarenessEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseExternalIntelligenceMarketAwarenessEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseExternalIntelligenceMarketAwarenessEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseExternalIntelligenceMarketAwarenessEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
