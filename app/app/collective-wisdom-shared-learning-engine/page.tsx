import { CollectiveWisdomSharedLearningEngineDashboardPanel } from "@/components/app/collective-wisdom-shared-learning-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function CollectiveWisdomSharedLearningEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "collectiveWisdomSharedLearningEngine");
  const t = createTranslator(dict);
  const p = "customerApp.collectiveWisdomSharedLearningEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <CollectiveWisdomSharedLearningEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
