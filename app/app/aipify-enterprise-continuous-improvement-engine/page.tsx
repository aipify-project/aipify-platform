import { AipifyEnterpriseContinuousImprovementEngineDashboardPanel } from "@/components/app/aipify-enterprise-continuous-improvement-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseContinuousImprovementEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseContinuousImprovementEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseContinuousImprovementEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseContinuousImprovementEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
