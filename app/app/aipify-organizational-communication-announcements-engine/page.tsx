import { AipifyOrganizationalCommunicationAnnouncementsEngineDashboardPanel } from "@/components/app/aipify-organizational-communication-announcements-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyOrganizationalCommunicationAnnouncementsEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyOrganizationalCommunicationAnnouncementsEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyOrganizationalCommunicationAnnouncementsEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyOrganizationalCommunicationAnnouncementsEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
