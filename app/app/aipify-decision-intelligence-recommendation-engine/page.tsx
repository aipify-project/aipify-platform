import { AipifyDecisionIntelligenceRecommendationEngineDashboardPanel } from "@/components/app/aipify-decision-intelligence-recommendation-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyDecisionIntelligenceRecommendationEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyDecisionIntelligenceRecommendationEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyDecisionIntelligenceRecommendationEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyDecisionIntelligenceRecommendationEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
