import { AipifyResourceCapacityWorkloadBalanceEngineDashboardPanel } from "@/components/app/aipify-resource-capacity-workload-balance-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyResourceCapacityWorkloadBalanceEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyResourceCapacityWorkloadBalanceEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyResourceCapacityWorkloadBalanceEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyResourceCapacityWorkloadBalanceEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
