import { AipifyKnowledgeDiscoveryIntelligentSearchEngineDashboardPanel } from "@/components/app/aipify-knowledge-discovery-intelligent-search-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyKnowledgeDiscoveryIntelligentSearchEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyKnowledgeDiscoveryIntelligentSearchEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyKnowledgeDiscoveryIntelligentSearchEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyKnowledgeDiscoveryIntelligentSearchEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
