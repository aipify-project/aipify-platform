import { AipifyOperationsOrchestrationEngineDashboardPanel } from "@/components/app/aipify-operations-orchestration-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyOperationsOrchestrationEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyOperationsOrchestrationEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyOperationsOrchestrationEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyOperationsOrchestrationEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
