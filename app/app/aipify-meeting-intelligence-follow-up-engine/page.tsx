import { AipifyMeetingIntelligenceFollowUpEngineDashboardPanel } from "@/components/app/aipify-meeting-intelligence-follow-up-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyMeetingIntelligenceFollowUpEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyMeetingIntelligenceFollowUpEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyMeetingIntelligenceFollowUpEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyMeetingIntelligenceFollowUpEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
