import { AipifyEnterpriseLegacyStewardshipEngineDashboardPanel } from "@/components/app/aipify-enterprise-legacy-stewardship-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseLegacyStewardshipEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseLegacyStewardshipEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseLegacyStewardshipEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseLegacyStewardshipEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
