...
export default async function ServiceNetworkProviderDetailPage({ params }: PageProps) {
  ...
  return <ServiceNetworkDetailPanel labels={labels} entityType="provider" recordId={providerId} />;
}
