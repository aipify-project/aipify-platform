import { AipifyEnterpriseCommitmentAccountabilityEngineDashboardPanel } from "@/components/app/aipify-enterprise-commitment-accountability-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseCommitmentAccountabilityEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseCommitmentAccountabilityEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseCommitmentAccountabilityEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseCommitmentAccountabilityEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
