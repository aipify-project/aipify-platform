...
export default async function MarketplacePartnerEcosystemFoundationEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "marketplacePartnerEcosystemFoundationEngine");
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <MarketplacePartnerEcosystemFoundationEngineDashboardPanel labels={{
          ...
          marketIntelligenceTitle: t(`${p}.marketIntelligenceTitle`),
          blueprintPhase51: t(`${p}.blueprintPhase51`),
          ecosystemGrowthSummary: t(`${p}.ecosystemGrowthSummary`),
          nordicPartnerIndicators: t(`${p}.nordicPartnerIndicators`),
          openOpportunities: t(`${p}.openOpportunities`),
          activeCustomers: t(`${p}.activeCustomers`),
          scheduledFollowUps: t(`${p}.scheduledFollowUps`),
          salesExpertSignals: t(`${p}.salesExpertSignals`),
          marketIntelligenceObjectives: t(`${p}.marketIntelligenceObjectives`),
          marketObservations: t(`${p}.marketObservations`),
          industryIntelligence: t(`${p}.industryIntelligence`),
          regionalInsights: t(`${p}.regionalInsights`),
          salesExpertFeedbackLoops: t(`${p}.salesExpertFeedbackLoops`),
          partnerEcosystemInsights: t(`${p}.partnerEcosystemInsights`),
          executiveSupport: t(`${p}.executiveSupport`),
          marketIntelligenceSuccessCriteria: t(`${p}.marketIntelligenceSuccessCriteria`),
          marketIntelligenceSelfLove: t(`${p}.marketIntelligenceSelfLove`),
          marketIntelligenceTrust: t(`${p}.marketIntelligenceTrust`),
          marketIntelligenceDogfooding: t(`${p}.marketIntelligenceDogfooding`),
          marketIntelligenceVision: t(`${p}.marketIntelligenceVision`),
        }} />
    </div>
  );
}
