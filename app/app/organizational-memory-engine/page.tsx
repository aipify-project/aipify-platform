...
export default async function OrganizationalMemoryEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "organizationalMemoryEngine");
    ...
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <OrganizationalMemoryEngineDashboardPanel
        labels={{
          ...
          futureLeadersEngine: t(`${p}.futureLeadersEngine`),
          continuityEngine: t(`${p}.continuityEngine`),
          phase152Title: t(`${p}.phase152.title`),
          phase152Objectives: t(`${p}.phase152.objectives`),
          phase152LegacyCenter: t(`${p}.phase152.legacyCenter`),
          phase152Succession: t(`${p}.phase152.succession`),
          phase152CriticalKnowledge: t(`${p}.phase152.criticalKnowledge`),
          phase152ExecutiveLegacy: t(`${p}.phase152.executiveLegacy`),
          phase152LegacyCompanion: t(`${p}.phase152.legacyCompanion`),
          phase152ContinuityReadiness: t(`${p}.phase152.continuityReadiness`),
          phase152Storytelling: t(`${p}.phase152.storytelling`),
          phase152InstitutionalMemory: t(`${p}.phase152.institutionalMemory`),
          phase152CompanionLimitations: t(`${p}.phase152.companionLimitations`),
          phase152SelfLove: t(`${p}.phase152.selfLove`),
          phase152Security: t(`${p}.phase152.security`),
          phase152Engagement: t(`${p}.phase152.engagement`),
          phase152SuccessCriteria: t(`${p}.phase152.successCriteria`),
          phase152IntegrationLinks: t(`${p}.phase152.integrationLinks`),
          successionPlans: t(`${p}.phase152.successionPlans`),
          knowledgeEntries: t(`${p}.phase152.knowledgeEntries`),
          legacyReviews: t(`${p}.phase152.legacyReviews`),
          storyRecords: t(`${p}.phase152.storyRecords`),
        }}
      />
    </div>
  );
