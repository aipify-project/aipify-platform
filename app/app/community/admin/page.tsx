    ...
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <CommunityAdminPanel
        labels={{
          ...
          publish: t(`${p}.publish`),
          approvePublication: t(`${p}.approvePublication`),
          advanceReview: t(`${p}.advanceReview`),
