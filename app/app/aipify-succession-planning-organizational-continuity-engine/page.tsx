import { AipifySuccessionPlanningOrganizationalContinuityEngineDashboardPanel } from "@/components/app/aipify-succession-planning-organizational-continuity-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifySuccessionPlanningOrganizationalContinuityEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifySuccessionPlanningOrganizationalContinuityEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifySuccessionPlanningOrganizationalContinuityEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifySuccessionPlanningOrganizationalContinuityEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
