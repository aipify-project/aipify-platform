import { AipifyEnterpriseExecutionConfidenceEngineDashboardPanel } from "@/components/app/aipify-enterprise-execution-confidence-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseExecutionConfidenceEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseExecutionConfidenceEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseExecutionConfidenceEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseExecutionConfidenceEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
