import { UniversalStewardshipSharedFuturesEngineDashboardPanel } from "@/components/app/universal-stewardship-shared-futures-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function UniversalStewardshipSharedFuturesEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "universalStewardshipSharedFuturesEngine");
  const t = createTranslator(dict);
  const p = "customerApp.universalStewardshipSharedFuturesEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <UniversalStewardshipSharedFuturesEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
