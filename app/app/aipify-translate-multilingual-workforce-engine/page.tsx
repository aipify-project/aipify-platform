import { AipifyTranslateMultilingualWorkforceEngineDashboardPanel } from "@/components/app/aipify-translate-multilingual-workforce-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyTranslateMultilingualWorkforceEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyTranslateMultilingualWorkforceEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyTranslateMultilingualWorkforceEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyTranslateMultilingualWorkforceEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
