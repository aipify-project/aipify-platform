import { AipifyEnterpriseTrainingCertificationEngineDashboardPanel } from "@/components/app/aipify-enterprise-training-certification-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseTrainingCertificationEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseTrainingCertificationEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseTrainingCertificationEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseTrainingCertificationEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
