import { AipifyEnterpriseRiskResilienceEngineDashboardPanel } from "@/components/app/aipify-enterprise-risk-resilience-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseRiskResilienceEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseRiskResilienceEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseRiskResilienceEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseRiskResilienceEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
