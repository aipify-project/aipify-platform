...
export default async function StrategicRecommendationsPage() {
  ...
  return (
    <StrategicIntelligencePanel
      ...
      titleOverride={labels.recommendationsTitle}
      visibleTabs={["overview", "recommendations", "opportunities", "executive_dashboard"]}
    />
  );
}
