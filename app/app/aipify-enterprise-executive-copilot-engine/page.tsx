import { AipifyEnterpriseExecutiveCopilotEngineDashboardPanel } from "@/components/app/aipify-enterprise-executive-copilot-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseExecutiveCopilotEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseExecutiveCopilotEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseExecutiveCopilotEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseExecutiveCopilotEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
