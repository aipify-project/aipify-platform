import { AipifyInnovationOpportunityDiscoveryEngineDashboardPanel } from "@/components/app/aipify-innovation-opportunity-discovery-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyInnovationOpportunityDiscoveryEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyInnovationOpportunityDiscoveryEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyInnovationOpportunityDiscoveryEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyInnovationOpportunityDiscoveryEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
