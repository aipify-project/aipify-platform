import { AipifyPrinciplesEnforcementEngineDashboardPanel } from "@/components/app/aipify-principles-enforcement-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyPrinciplesEnforcementEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyPrinciplesEnforcementEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyPrinciplesEnforcementEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyPrinciplesEnforcementEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
