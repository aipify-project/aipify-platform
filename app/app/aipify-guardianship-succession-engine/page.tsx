import { AipifyGuardianshipSuccessionEngineDashboardPanel } from "@/components/app/aipify-guardianship-succession-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyGuardianshipSuccessionEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyGuardianshipSuccessionEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyGuardianshipSuccessionEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyGuardianshipSuccessionEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
