...
export default async function EvolutionMaturityPage() {
  ...
  return (
    <EvolutionOperationsPanel
      labels={labels}
      initialTab="maturity"
      titleOverride={labels.maturityTitle}
      subtitleOverride={labels.maturitySubtitle}
      visibleTabs={["overview", "maturity", "optimization", "executive", "reports"]}
    />
  );
}
