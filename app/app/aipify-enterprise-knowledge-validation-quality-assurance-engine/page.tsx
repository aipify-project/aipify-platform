import { AipifyEnterpriseKnowledgeValidationQualityAssuranceEngineDashboardPanel } from "@/components/app/aipify-enterprise-knowledge-validation-quality-assurance-engine";
import { getCustomerAppDictionaryForModule } from "@/lib/i18n/get-dictionary";
import { getLocale } from "@/lib/i18n/get-locale";
import { createTranslator } from "@/lib/i18n/translate";

export default async function AipifyEnterpriseKnowledgeValidationQualityAssuranceEnginePage() {
  const dict = await getCustomerAppDictionaryForModule(await getLocale(), "aipifyEnterpriseKnowledgeValidationQualityAssuranceEngine");
  const t = createTranslator(dict);
  const p = "customerApp.aipifyEnterpriseKnowledgeValidationQualityAssuranceEngine";
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <AipifyEnterpriseKnowledgeValidationQualityAssuranceEngineDashboardPanel
        labels={{
          loading: t(`${p}.loading`),
