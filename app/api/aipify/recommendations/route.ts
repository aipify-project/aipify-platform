...
import { parseCompanionRecommendationsDashboard } from "@/lib/aipify/companion-recommendation-engine/parse";
...
export async function GET(request: Request) {
  try {
    ...
    return NextResponse.json(parseCompanionRecommendationsDashboard(data));
  } catch {
