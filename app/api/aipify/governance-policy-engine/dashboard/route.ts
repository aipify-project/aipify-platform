...
import { parseGovernancePolicyEngineDashboard } from "@/lib/aipify/governance-policy-engine";
...
export async function GET() {
  try {
    ...
    return NextResponse.json(parseGovernancePolicyEngineDashboard(data));
  } catch {
