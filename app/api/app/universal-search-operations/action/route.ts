...
import { performUniversalSearchAction } from "@/lib/universal-search-operations";
...
export async function POST(request: Request) {
  try {
    ...
    const result = await performUniversalSearchAction(supabase, body.action_type, body.payload ?? {});
