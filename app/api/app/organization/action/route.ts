...
import { performOrganizationManagementAction } from "@/lib/organization-management";
...
export async function POST(request: Request) {
  try {
    ...
    const data = await performOrganizationManagementAction(supabase, body.action_type ?? "", body.payload ?? {});
