...
import { performAutomationOperationsAction } from "@/lib/automation-operations";
...
export async function POST(request: Request) {
  try {
    ...
    const result = await performAutomationOperationsAction(supabase, body.action_type, body.payload ?? {});
