...
import { performGovernanceManagementAction } from "@/lib/governance-management";
...
export async function POST(request: Request) {
  try {
    ...
    const data = await performGovernanceManagementAction(supabase, body.action_type ?? "", body.payload ?? {});
