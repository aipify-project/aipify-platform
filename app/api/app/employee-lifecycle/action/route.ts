...
import { performEmployeeLifecycleAction } from "@/lib/employee-lifecycle";
...
export async function POST(request: Request) {
  try {
    ...
    const data = await performEmployeeLifecycleAction(supabase, body.action_type ?? "", body.payload ?? {});
