...
import { performResourceCapacityAction } from "@/lib/customer-resource-capacity-operations";
...
export async function POST(request: Request) {
  try {
    ...
    const data = await performResourceCapacityAction(supabase, action_type, payload);
