...
import { performExecutionOutcomeAction } from "@/lib/customer-execution-outcome-operations";
...
export async function POST(request: Request) {
  try {
    ...
    const data = await performExecutionOutcomeAction(supabase, action_type, payload);
