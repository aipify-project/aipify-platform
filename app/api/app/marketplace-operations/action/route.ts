...
import { performMarketplaceOperationsAction } from "@/lib/marketplace-operations";
...
export async function POST(request: Request) {
  try {
    ...
    const data = await performMarketplaceOperationsAction(supabase, body.action_type ?? "", body.payload ?? {});
