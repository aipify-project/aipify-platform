...
import { performFinanceOperationsAction } from "@/lib/finance-operations";
...
export async function POST(request: Request) {
  try {
    ...
    const data = await performFinanceOperationsAction(supabase, body.action_type ?? "", body.payload ?? {});
