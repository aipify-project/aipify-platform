...
import { performKnowledgeGraphAction } from "@/lib/knowledge-graph-operations";
...
export async function POST(request: Request) {
  try {
    ...
    const result = await performKnowledgeGraphAction(supabase, body.action_type, body.payload ?? {});
