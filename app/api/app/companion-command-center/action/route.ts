...
import { performCompanionCommandCenterAction } from "@/lib/companion-command-center";
...
export async function POST(request: Request) {
  try {
    ...
    const result = await performCompanionCommandCenterAction(supabase, body.action_type, body.payload ?? {});
