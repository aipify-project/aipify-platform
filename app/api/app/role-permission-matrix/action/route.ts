...
import { performRolePermissionMatrixAction } from "@/lib/role-permission-matrix";
...
export async function POST(request: Request) {
  try {
    ...
    const result = await performRolePermissionMatrixAction(supabase, body.action_type, body.payload ?? {});
