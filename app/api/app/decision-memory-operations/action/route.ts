...
import { performDecisionMemoryAction } from "@/lib/customer-decision-memory-operations";
...
export async function POST(request: Request) {
  try {
    ...
    const data = await performDecisionMemoryAction(supabase, action_type, payload);
