...
const block = en.portalStructure.enterpriseBenchmarking;
const navVal = en.portalStructure.nav.enterpriseBenchmarking;
...
for (const loc of ["no", "sv", "da", "es", "pl", "uk"]) {
  ...
  data.portalStructure.nav.enterpriseBenchmarking = navVal;
  data.portalStructure.enterpriseBenchmarking = block;
