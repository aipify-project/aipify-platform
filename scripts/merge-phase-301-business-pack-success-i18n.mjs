...
const block = en.portalStructure.businessPackSuccess;
const navVal = en.portalStructure.nav.businessPackSuccess;
...
for (const loc of ["no", "sv", "da", "es", "pl", "uk"]) {
  ...
  data.portalStructure.nav.businessPackSuccess = navVal;
  data.portalStructure.businessPackSuccess = block;
