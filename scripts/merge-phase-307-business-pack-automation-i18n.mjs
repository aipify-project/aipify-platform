...
const block = en.portalStructure.businessPackAutomation;
const navVal = en.portalStructure.nav.businessPackAutomation;
...
for (const loc of ["no", "sv", "da", "es", "pl", "uk"]) {
  ...
  data.portalStructure.nav.businessPackAutomation = navVal;
  data.portalStructure.businessPackAutomation = block;
