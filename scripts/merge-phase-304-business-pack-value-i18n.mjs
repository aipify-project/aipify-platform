...
const block = en.portalStructure.businessPackValue;
const navVal = en.portalStructure.nav.businessPackValue;
...
for (const loc of ["no", "sv", "da", "es", "pl", "uk"]) {
  ...
  data.portalStructure.nav.businessPackValue = navVal;
  data.portalStructure.businessPackValue = block;
