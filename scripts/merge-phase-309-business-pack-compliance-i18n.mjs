...
const block = en.portalStructure.businessPackCompliance;
const navVal = en.portalStructure.nav.businessPackCompliance;
...
for (const loc of ["no", "sv", "da", "es", "pl", "uk"]) {
  ...
  data.portalStructure.nav.businessPackCompliance = navVal;
  data.portalStructure.businessPackCompliance = block;
