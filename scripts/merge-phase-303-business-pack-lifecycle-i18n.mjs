...
const block = en.portalStructure.businessPackLifecycle;
const navVal = en.portalStructure.nav.businessPackLifecycle;
...
for (const loc of ["no", "sv", "da", "es", "pl", "uk"]) {
  ...
  data.portalStructure.nav.businessPackLifecycle = navVal;
  data.portalStructure.businessPackLifecycle = block;
