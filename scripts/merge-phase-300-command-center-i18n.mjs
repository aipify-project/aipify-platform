...
const block = en.portalStructure.abosCommandCenter;
const navVal = en.portalStructure.nav.abosCommandCenter;
...
for (const loc of ["no", "sv", "da", "es", "pl", "uk"]) {
  ...
  data.portalStructure.nav.abosCommandCenter = navVal;
  data.portalStructure.abosCommandCenter = block;
