...
const block = en.portalStructure.businessPackGovernance;
const navVal = en.portalStructure.nav.businessPackGovernance;
...
for (const loc of ["no", "sv", "da", "es", "pl", "uk"]) {
  ...
  data.portalStructure.nav.businessPackGovernance = navVal;
  data.portalStructure.businessPackGovernance = block;
